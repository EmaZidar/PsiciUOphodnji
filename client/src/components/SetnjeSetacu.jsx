        ...
        <div className="setacu-sve-setnje">
            {setnje.map((s) => (
                <div key={s.idsetnja} className="setacu-jedna-setnja">
                    <p>
                        <strong>Datum:</strong> {formatDatumHR(s.datum)}
                    </p>
                    <p>
                        <strong>Vrijeme:</strong> {formatVrijeme(s.vrijeme)}
                    </p>
                    <p>
                        <strong>Polazište:</strong> {s.polaziste}
                    </p>
                    <p>
                        <strong>Tip šetnje:</strong> {s.tipsetnja}
                    </p>
                    <p>
                        <strong>Trajanje:</strong> {s.trajanje} min
                    </p>
                    <p>
                        <strong>Cijena:</strong> {s.cijena} €
                    </p>
                    ...
                    <p>
                        ...
                        {s.dodnapomene || "Nema dodatnih napomena"}
                    </p>
                </div>
            ))}
        </div>
